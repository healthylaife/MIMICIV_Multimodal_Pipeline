...
# ----------------------OUPUT FUNCTION ---------------------------
def mimic_notes_embedding_BioClinicalBERT(mimic_note_type):

    CURRENT_FILE_DIR = os.path.dirname(os.path.abspath(__file__))
    BASE_DIR = os.path.dirname(os.path.dirname(CURRENT_FILE_DIR))
    df = pd.read_csv(f"{BASE_DIR}/mimiciv/notes/{mimic_note_type}.csv.gz", compression='gzip',nrows=1000)
    ...
    out_path = f"{BASE_DIR}/data/cohort/notes_{mimic_note_type}_with_clinicalbert_embedding.csv"
